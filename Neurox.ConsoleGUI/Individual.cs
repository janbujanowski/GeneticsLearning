    ...
    public class Individual
    {
        ...
        public double? TestedSurvivalScore
        {
            get
            {
                ...
                {
                    _testedSurvivalScore = new StockMarketEvaluator(IoCFactory.Resolve<ILogger>(), IoCFactory.Resolve<IConfigurationProvider>().GetConfiguredFilePath("workingDirectory", "pathToTestMarketDataFile")).Ocena(genotype);
                }
