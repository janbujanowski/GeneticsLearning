...
namespace Neurox.ConsoleGUI
{
    public class DirectFileLogger : ILogger
    {
        ...
        {
            //get default logger
            _pathToInfoFile = IoCFactory.Resolve<IConfigurationProvider>().GetConfiguredFilePath("workingDirectory", "pathToInfoFile");
            _pathToExceptionFile = IoCFactory.Resolve<IConfigurationProvider>().GetConfiguredFilePath("workingDirectory", "pathToExceptionFile");
        }
